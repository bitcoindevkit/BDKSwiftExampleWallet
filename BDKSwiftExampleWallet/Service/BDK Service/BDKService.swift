...
private class BDKService {
    ...
    func loadWalletFromBackup() throws {
        ...
        let changeDescriptor = try Descriptor(
            descriptor: backupInfo.changeDescriptor, network: self.network)
...
extension BDKClient {
    ...
    let mockBalance = Balance(
        immature: 0, trustedPending: 0, untrustedPending: 0, confirmed: 21_418_468,
        spendable: 21_418_468, total: 21_418_468)
    let mockBalanceZero = Balance(
        immature: 0, trustedPending: 0, untrustedPending: 0, confirmed: 21_418_468, spendable: 0,
        total: 0)
    let mockTransactionDetails =
        [
            ...
            BitcoinDevKit.TransactionDetails(
                transaction: nil, fee: Optional(2820), received: 100000, sent: 0,
            ...
            BitcoinDevKit.TransactionDetails(
                transaction: nil, fee: Optional(141), received: 6250, sent: 0,
            ...
            BitcoinDevKit.TransactionDetails(
                transaction: nil, fee: Optional(141), received: 74859, sent: 100000,
            ...
            BitcoinDevKit.TransactionDetails(
                transaction: nil, fee: Optional(2820), received: 1_000_000, sent: 0,
            ...
            BitcoinDevKit.TransactionDetails(
                transaction: nil, fee: Optional(141), received: 50000, sent: 0,
            ...
            BitcoinDevKit.TransactionDetails(
                transaction: nil, fee: Optional(141), received: 87359, sent: 100000,
